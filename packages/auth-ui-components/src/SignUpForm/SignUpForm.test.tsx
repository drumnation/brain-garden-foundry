...
describe('SignUpForm', () => {
  ...
  it('should call onSuccess when signup succeeds', async () => {
    ...
    render(<SignUpForm onSuccess={mockOnSuccess} onSignUp={mockSignUp} />, { wrapper: TestWrapper });
  ...
  it('should call onError when signup fails', async () => {
    ...
    render(<SignUpForm onError={mockOnError} onSignUp={mockSignUp} />, { wrapper: TestWrapper });
